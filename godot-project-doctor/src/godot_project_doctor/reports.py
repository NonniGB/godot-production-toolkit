...
def render_html(summary: dict[str, object]) -> str:
    ...
    return "\n".join(
        [
            ...
            "<body>",
            "<main>",
            "<div class=\"eyebrow\">Godot production checks</div>",
            "<h1>Godot Project Doctor Report</h1>",
            "<p class=\"lead\">A compact release-readiness summary for export presets, assets, input maps, localization, scene wiring, and mobile performance checks.</p>",
            "<div class=\"totals\">",

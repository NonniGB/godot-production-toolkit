...
This is a portfolio-level implementation plan. Each tool remains standalone and should be implemented in its own repository or folder first, then published separately.

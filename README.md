...
| `godot-release-dashboard-kit` | Static workflow-grouped dashboard builder for toolkit reports, typed highlights, scenario retry evidence, visual artifacts, metadata, reproduction commands, and previous-run trends. | HTML, JSON |
...
| [`godot-release-dashboard-kit`](https://pypi.org/project/godot-release-dashboard-kit/) | `0.1.9` |

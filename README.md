...
| `godot-release-dashboard-kit` | Static workflow-grouped dashboard builder for toolkit reports, typed highlights, visual artifacts, metadata, reproduction commands, and previous-run trends. | HTML, JSON |

...
Build a publishable Godot production tooling suite with ten standalone tools, one umbrella CLI, one GitHub Action, complete documentation, examples, tests, CI-ready structure, and agent-readable manifests.
...
## Release And Automation Hardening
...
- Added root repository contract tests and project metadata tests.

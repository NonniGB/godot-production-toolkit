...
For user-facing behavior, update the relevant `CHANGELOG.md`. For root-level suite behavior, update the root `CHANGELOG.md`, `AI_REVIEW_PACKAGE.md`, and `oss-review-evidence.json` when the change affects automated review evidence.

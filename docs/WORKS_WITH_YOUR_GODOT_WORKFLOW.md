...
- `godot-release-dashboard-kit` turns existing reports and screenshots into a
  workflow-filtered static review page, with optional previous-run trends.
...
| `godot-release-dashboard-kit` | No | Builds workflow-filtered static HTML dashboards from existing toolkit reports and visual artifacts, with optional previous-run comparison cards. |

...
| Godot workflow-grouped release dashboard with previous-run trends | `python -m pip install godot-release-dashboard-kit` | `godot-release-dashboard build reports/current --previous-reports-dir reports/previous --output reports/dashboard.html` |

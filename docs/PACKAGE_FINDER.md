...
| Godot mobile performance static check | `python -m pip install godot-mobile-perf-doctor` | `godot-mobile-perf-doctor . --static --mobile-ui-metadata reports/mobile-ui.json --format markdown` |

...
| Godot workflow-grouped release dashboard | `python -m pip install godot-release-dashboard-kit` | `godot-release-dashboard build reports --output reports/dashboard.html` |

...
| GDScript architecture boundaries, high fan-in/fan-out files, and possible unused scripts | `godot-gdscript-architecture-guard` |
...
| Scenario evidence manifests, JUnit XML summaries, coverage, flake checks, and reports | `godot-scenario-report-kit` |
...
| Runtime telemetry budgets, timelines, and baseline comparisons | `godot-runtime-telemetry-lab` |

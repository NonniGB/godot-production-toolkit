...
| [Release checklist](godot-ci-release-checklist.md) | A pull request or release branch needs compact release evidence. | Godot project folder and optional tool config. | `godot-project-doctor` summary and dashboard inputs. |
...
| [Save migration testing](godot-save-migration-testing.md) | Save format changes need fixture and migration proof. | Save fixtures, JSON schema, optional migration chain. | Generated fixture report, migration plan, and save compatibility report. |

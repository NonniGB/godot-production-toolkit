...
| [Localization overflow testing](godot-localization-overflow-testing.md) | Translated text may break placeholders, keys, or visible layout. | CSV/PO files, scripts, optional UI metadata. | Localization QA report, stress catalogs, and layout-risk inputs. |
